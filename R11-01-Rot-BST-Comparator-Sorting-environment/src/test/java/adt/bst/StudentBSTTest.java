...
public class StudentBSTTest {
    ...
    private void fillTree() {
        ...
        Integer[] array2 = {6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40,7,11,3};
        for (int i : array2) {
            tree2.insert(i);
        }
    }
    ...
    public void setUp() {
        tree = new BSTImpl<>();
        tree2 = new SortComparatorBSTImpl<Integer>((o1, o2) -> o1 - o2);
    }
    ...
    public void testInit() {
        ...
        assertEquals(NIL, tree2.getRoot());

        assertArrayEquals(new Integer[]{}, tree2.order());
        assertArrayEquals(new Integer[]{}, tree2.preOrder());
        assertArrayEquals(new Integer[]{}, tree2.postOrder());

        assertEquals(NIL, tree2.search(12));
        assertEquals(NIL, tree2.search(-23));
        assertEquals(NIL, tree2.search(0));

        assertEquals(null, tree2.minimum());
        assertEquals(null, tree2.maximum());

        assertEquals(null, tree2.sucessor(12));
        assertEquals(null, tree2.sucessor(-23));
        assertEquals(null, tree2.sucessor(0));

        assertEquals(null, tree2.predecessor(12));
        assertEquals(null, tree2.predecessor(-23));
        assertEquals(null, tree2.predecessor(0));
    }
    ...
    public void testSucessorPredecessor() {
        ...
        assertEquals(null, tree2.predecessor(-40));
        assertEquals(new Integer(-34), tree2.sucessor(-40).getData());

        assertEquals(new Integer(-40), tree2.predecessor(-34).getData());
        assertEquals(new Integer(0), tree2.sucessor(-34).getData());

        assertEquals(new Integer(-34), tree2.predecessor(0).getData());
        assertEquals(new Integer(2), tree2.sucessor(0).getData());

        assertEquals(new Integer(0), tree2.predecessor(2).getData());
        assertEquals(new Integer(3), tree2.sucessor(2).getData());
    }
    ...
    public void testSize() {
        ...
        int size2 = 15;
        assertEquals(size2, tree2.size());

        while (!tree2.isEmpty()) {
            tree2.remove(tree2.getRoot().getData());
            assertEquals(--size2, tree2.size());
        }
    }
    ...
    public void testHeight() {
        ...
        Integer[] preOrder2 = new Integer[]{6, -34, -40, 5, 2, 0, 3, 23, 9, 7, 12, 11, 76, 67, 232};
        assertArrayEquals(preOrder2, tree2.preOrder());
    ...
    public void testRemove2() {
        ...
        Integer[] order = {-40, -34, 0, 2,3, 5, 6,7, 9,11, 12, 23, 67, 76, 232};
        assertArrayEquals(order, tree2.order());

        tree2.remove(6);
        order = new Integer[]{-40, -34, 0, 2,3, 5,7, 9,11, 12, 23, 67, 76, 232};
        assertArrayEquals(order, tree2.order());

        tree2.remove(9);
        order = new Integer[]{-40, -34, 0, 2,3, 5,7,11, 12, 23, 67, 76, 232};
        assertArrayEquals(order, tree2.order());

        assertEquals(NIL, tree2.search(6));
        assertEquals(NIL, tree2.search(9));
    ...
    public void testReverse() {
        ...
        Integer[] reverseOrder = {232, 76, 67, 23, 12, 11, 9, 7, 6, 5, 3, 2, 0, -34, -40};
        assertArrayEquals(reverseOrder, ((SortComparatorBSTImpl<Integer>) tree2).reverseOrder());

        tree2.remove(6);
        reverseOrder = new Integer[]{232, 76, 67, 23, 12, 11, 9, 7, 5, 3, 2, 0, -34, -40};
        assertArrayEquals(reverseOrder, ((SortComparatorBSTImpl<Integer>) tree2).reverseOrder());

        tree2.remove(9);
        reverseOrder = new Integer[]{232, 76, 67, 23, 12, 11, 7, 5, 3, 2, 0, -34, -40};
        assertArrayEquals(reverseOrder, ((SortComparatorBSTImpl<Integer>) tree2).reverseOrder());
    ...
    public void testOrder(){
        ...
        Integer[] reverseOrder = {232, 76, 67, 23, 12, 11, 9, 7, 6, 5, 3, 2, 0, -34, -40};
        Integer[] order = {-40, -34, 0, 2,3, 5, 6,7, 9,11, 12, 23, 67, 76, 232};
        Integer[] array = {6, 23, -34, 5, 9, 2, 0, 76, 12, 67, 232, -40,11,7,3};
        assertEquals(order, ((SortComparatorBSTImpl<Integer>) tree2).sort(array));
        assertEquals(order, ((SortComparatorBSTImpl<Integer>) tree2).sort(order));
        assertEquals(order, ((SortComparatorBSTImpl<Integer>) tree2).sort(reverseOrder));
    }
    ...
    public void testSearch2() {
        ...
        assertEquals(new Integer(-40), tree2.search(-40).getData());
        assertEquals(new Integer(-34), tree2.search(-34).getData());
    ...
    public void customTest2() {
        BSTImpl<Integer> bst = new SortComparatorBSTImpl<>((o1, o2) -> o1 - o2);
