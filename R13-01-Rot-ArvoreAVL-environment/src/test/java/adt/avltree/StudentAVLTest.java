...
public class StudentAVLTest {
    ...
    @Test
    public void testeUltimo(){
        Integer[] array = new Integer[]{55, 9, 7, 6, 3, 8, 15, 12, 17, 40, 90, 61, 59, 87, 91};
        Integer[] array2 = new Integer[]{55, 91, 7, 61, 3, 8, 15, 12, 17, 40, 90, 6, 59, 87, 9};
        int size = 0;
        assertTrue(avl.isEmpty());
